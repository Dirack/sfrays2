...
struct RayTrace {
    bool sym; /* Usar integrador simplético? true=yes */
    int dim, nt; /* dim é 2d ou 3d, nt é o número de passos do traçamento de raio */
    float dt, z0; /* dt é a amostragem do raio, z0 é o z inicial */
    grid3 grd3; /* grid para traçamento 3d */
    grid2 grd2; /* grid para traçamento 2d */
};
/* concrete data type */
